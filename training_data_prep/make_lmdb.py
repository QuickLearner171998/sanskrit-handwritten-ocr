...
def getArgs():
    ...
    parser.add_argument('--data_root_dir', default="/ihub/homedirs/am_cse/pramay/work/Dataset", type=str)
    parser.add_argument('--label_file_paths', default=["/ihub/homedirs/am_cse/pramay/work/Dataset/real_training_v1/train_data/rec_gt_val.txt"], nargs='+')
                                                    #    "/ihub/homedirs/am_cse/pramay/work/Dataset/real_training_v1/train_data/rec_gt_val.txt"], n
    parser.add_argument('--delimiter', type=str, default='tab')
    parser.add_argument('--lmdb_out_dir', default="/ihub/homedirs/am_cse/pramay/work/Dataset/real_training_v1/train_data/val_lmdb", type=str)
